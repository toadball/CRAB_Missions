class NATOSF_CUPWEP_WDL {
  class BaseUnit {
    ...
    ace_medic = 1;
    weapons[] = {
      {"CUP_arifle_DSA_SA58_OSW_VFG",{"rhsusf_acc_su230a","rhsusf_acc_anpeq15side_bk","CUP_20Rnd_762x51_FNFAL_M"}},
  ...
  class UGL: BaseUnit {
    weapons[] = {
      {"CUP_arifle_DSA_SA58_OSW_M203",{"rhsusf_acc_su230a","rhsusf_acc_anpeq15side_bk","CUP_20Rnd_762x51_FNFAL_M","1Rnd_HE_Grenade_shell"}},
      {"hgun_Pistol_heavy_01_green_F",{"11Rnd_45ACP_Mag"}}
    };
    ...
    backpackContents[] = {
      {"CUP_20Rnd_762x51_FNFAL_M",4},
      {"CUP_20Rnd_TE1_Red_Tracer_762x51_FNFAL_M",4},
      {"HandGrenade",2},
      {"SmokeShell",2},
      {"Chemlight_green",2},
  ...
  class DMR: BaseUnit {
    weapons[] = {
      {"CUP_arifle_DSA_SA58_DMR",{"rhsusf_acc_su230a","rhsusf_acc_anpeq15side_bk","bipod_01_f_blk","CUP_20Rnd_762x51_FNFAL_M"}},
      {"hgun_Pistol_heavy_01_green_F",{"11Rnd_45ACP_Mag"}},
      "ACE_Vector"
    };
    vest[] = {"V_PlateCarrier2_wdl"};
