class Bermany {
    ...
    class ZEUS: PL {
        assignedItems[] = {"ItemMap","ItemCompass","ItemWatch","ACE_NVG_Wide"};
        backpack[] = {};
        backpackContents[] = {};
    };
    ...
    class DMR: BaseUnit {
        weapons[] = {
            {"CUP_arifle_HK417_20",{"ACE_20Rnd_762x51_Mk316_Mod_0_Mag","cup_optic_leupoldm3lr_pip","cup_acc_anpeq_15","cup_bipod_harris_1a2_l_blk"}},
    ...
    class SupplyCrate {
        vehCargoWeapons[] = {
            {"rhs_weap_M136_hp",4},
            {"rhs_weap_m72a7",8},
            {"CUP_arifle_G36A_RIS",4}
        };
        vehCargoMagazines[] = {
            {"rhsgref_30rnd_556x45_vhs2",64},
            {"rhsgref_30rnd_556x45_vhs2_t",16},
            {"CUP_1Rnd_HEDP_M203",32},
            {"rhsusf_200rnd_556x45_mixed_box",8},
            {"CUP_100Rnd_556x45_BetaCMag",8},
            {"ACE_20Rnd_762x51_Mk316_Mod_0_Mag",16},
            {"CUP_5Rnd_762x67_G22",16},
            {"rhs_mag_rgd5",24},
            {"rhs_mag_rgn",16},
            {"SmokeShell",16}
        };
